...
import { JEAN_COMMANDS } from './jean'
...
const ALL_COMMANDS: CommandDefinition[] = [
  ...
  // Mode commands generated from AGENT_MODES; the client maps each onto
  // Jean's effort and permission settings.
  ...
  defineCommandWithArgs({
    name: 'connect',
    aliases: ['providers'],
    handler: (params, args) => handleConnectCommand(params, args),
  }),
  defineCommandWithArgs({
    name: 'models',
    handler: (params, args) => {
...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...ALL_COMMANDS,
  // Jean's session verbs, shared with the line-based CLI.
  ...JEAN_COMMANDS,
]
